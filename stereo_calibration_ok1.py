...
imagesLeft = sorted(glob.glob('/home/airlab/Desktop/Calib_multiple_stereo/IMG_VIEWS/degree240/image_L_*.jpg'))
imagesRight = sorted(glob.glob('/home/airlab/Desktop/Calib_multiple_stereo/IMG_VIEWS/degree240/image_R_*.jpg'))
for imgLeft, imgRight in zip(imagesLeft, imagesRight):
    ...
    if retL == True and retR == True:
        ...
        cv.imshow('img left', resized_img(imgL,15))
        cv.drawChessboardCorners(imgR, chessboardSize, cornersR, retR)
        cv.imshow('img right', resized_img(imgR,15))
        cv.waitKey(1)
...
cv_file = cv.FileStorage('/home/airlab/Desktop/Transformation_matrix/result_image/Calibrated/degree0/stereoMap.txt', cv.FILE_STORAGE_WRITE)
